...
# Proyección simple: repetir último año
ventas_anuales['Demanda_Proyectada'] = ventas_anuales['Venta_Anual']

# Stock seguridad = Z * desv. estándar mensual
Z = 1.65
...
# COSTO FICTICIO (puedes reemplazar por base real)
...
# GRÁFICO: DISPERSIÓN MARGEN VS VENTA
